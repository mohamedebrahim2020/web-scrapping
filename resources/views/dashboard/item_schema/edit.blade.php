...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="post" action="{{ url('dashboard/item-schema/' . $itemSchema->id) }}" enctype="multipart/form-data"
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="css_expression" value="{{ $itemSchema->css_expression }}"
                                class="form-control" id="cssExpression" />
                            <span id="cssExpressionErr"></span>
                            <div class="help-block">CSS expression identifies css selector for specific item in a single
                                article separated by ||. i.e h2.post_title for title</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="checkbox" name="is_full_url" value="1"
                                {{ $itemSchema->is_full_url ? 'checked' : '' }} />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="full_content_selector" value="{{ $itemSchema->full_content_selector }}"
                                class="form-control" id="fullContentSelector" />
