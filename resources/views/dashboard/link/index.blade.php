                ...
                <table class="table table-bordered">
                    ...
                    @foreach ($links as $link)
                        <tr data-id="{{ $link->id }}">
                            ...
                            <td>{{ $link->website->Website_name }} </td>
                            <td>
                                <select class="item_schema" data-id="{{ $link->id }}"
                                    data-original-schema="{{ $link->item_schema_id }}">
                                ...
                                <button type="button" class="btn btn-info btn-sm btn-apply"
                            ...
                            <td>
                                <a href="{{ url('dashboard/links/' . $link->id . '/edit') }}"><i
